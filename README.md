...
* [X] Added border line between individual tweets
* [X] Added Verified symbol for users
* [X] Show Retweeted tweets with original tweet information 
* [X] Changed the App Icon to Twitter's logo
* [X] Made Compose Button a FloatingActionButton to reflect Twitter's
